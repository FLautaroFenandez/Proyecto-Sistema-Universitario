...
export function Topbar() {
  return (
    <div className="bg-brand-azul text-white/85 text-xs py-1.5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        {/* Scroll horizontal en mobile, fila en desktop */}
        <div className="flex items-center gap-0 overflow-x-auto no-scrollbar whitespace-nowrap">

          {/* Teléfono */}
          <a
            href="tel:+5493625550100"
          ...
          <a
            href="/noticias"
            className="hidden md:flex items-center gap-1.5 px-3 py-0.5 hover:text-white transition-colors"
          >
            <Calendar size={11} />
          ...
          {/* Ubicación */}
          <span className="flex items-center gap-1.5 px-3 py-0.5 text-white/85">
            <MapPin size={11} />
